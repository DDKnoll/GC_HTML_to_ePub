 ...
 * 
 * This file provides functions that initialize an array of manifest items
 *
 * To Do: look at filename length constants
 *        
 *
 */
...
//takes a pointer to a directory 
...
void * main () {
  manifest * manifest_ptr = create_manifest();
  itemNode * node_ptr = manifest_ptr->first;
